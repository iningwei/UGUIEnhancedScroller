...
namespace EnhancedScrollerDemos.SuperSimpleDemo
{
    ...
    public class SimpleDemo : MonoBehaviour, IEnhancedScrollerDelegate
    {
        ...
        private void onCellViewVisibilityChanged(EnhancedScrollerCellView cellView)
        {
            if (cellView.active)
            {
                Debug.LogError("data index:" + cellView.dataIndex + ", cellIndexs:" + cellView.cellIndex + ", show");
            }
            else
            {
                //Debug.LogError("data index:" + cellView.dataIndex + ", cellIndexs:" + cellView.cellIndex + ", hide");
            }
